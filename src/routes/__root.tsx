...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://open-connect.site/open-connect-brand-lockup.png" },
      { property: "og:image:alt", content: "Open Connect platform logo" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:image", content: "https://open-connect.site/open-connect-brand-lockup.png" },
    ],
    links: [
