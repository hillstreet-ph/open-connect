...
// Includes guides, studio, orgs, secrets, admin, integrations, roles, v1 root.
...
export interface FileRouteTypes {
  ...
  fullPaths: '/' | '/auth' | '/login' | '/connections' | '/explore' | '/integrations' | '/mcp' | '/models' | '/resources' | '/admin' | '/agents' | '/api-keys' | '/dashboard' | '/guides' | '/orgs' | '/roles' | '/secrets' | '/settings' | '/studio' | '/toolkits' | '/oauth/authorize' | '/oauth/register' | '/oauth/token' | '/v1' | '/v1/models' | '/api/v1/health' | '/api/v1/resources' | '/v1/chat/completions'
  fileRoutesByTo: FileRoutesByTo
  to: '/' | '/auth' | '/login' | '/connections' | '/explore' | '/integrations' | '/mcp' | '/models' | '/resources' | '/admin' | '/agents' | '/api-keys' | '/dashboard' | '/guides' | '/orgs' | '/roles' | '/secrets' | '/settings' | '/studio' | '/toolkits' | '/oauth/authorize' | '/oauth/register' | '/oauth/token' | '/v1' | '/v1/models' | '/api/v1/health' | '/api/v1/resources' | '/v1/chat/completions'
  id: '__root__' | '/' | '/_authenticated' | '/auth' | '/login' | '/connections' | '/explore' | '/integrations' | '/mcp' | '/models' | '/resources' | '/_authenticated/admin' | '/_authenticated/agents' | '/_authenticated/api-keys' | '/_authenticated/dashboard' | '/_authenticated/guides' | '/_authenticated/orgs' | '/_authenticated/roles' | '/_authenticated/secrets' | '/_authenticated/settings' | '/_authenticated/studio' | '/_authenticated/toolkits' | '/oauth/authorize' | '/oauth/register' | '/oauth/token' | '/v1/' | '/v1/models' | '/api/v1/health' | '/api/v1/resources' | '/v1/chat/completions'
